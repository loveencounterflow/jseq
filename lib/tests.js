(function() {
  ...
  module.exports = function(eq, ne) {
    ...
    //---------------------------------------------------------------------------------------------------------
    R["fn1: two functions are always ne"] = function() {
      var d, e;
    ...
    //---------------------------------------------------------------------------------------------------------
    R["fn1: functions are eq to themselves"] = function() {
      var d, e;
      d = function( a, b, c ){ return a * b * c; };
      e = d;
      return eq(d, e);
    ...
    //---------------------------------------------------------------------------------------------------------
    R["empty objs ne when diff prototypes"] = function() {
      var d, e;
      d = {};
    ...
    //---------------------------------------------------------------------------------------------------------
    R["(1) circ arrays w similar layout, same values aren't eq"] = function() {
      var d, e;
      d = [1, 2, 3];
      d.push(d);
      e = [1, 2, 3];
    ...
    //---------------------------------------------------------------------------------------------------------
    R["(MapSet1) Support for Maps and Sets"] = function() {
      var a, b;
      a = new Set('abcdef');
      b = new Set('abcdef');
      return eq(a, b);
    ...
    //---------------------------------------------------------------------------------------------------------
    R["(MapSet2) Support for Maps and Sets"] = function() {
      var a, b;
      a = new Set('abcdef');
      b = new Set('abcdefg');
      return ne(a, b);
    ...
    //---------------------------------------------------------------------------------------------------------
    R["(MapSet3) Support for Maps and Sets"] = function() {
      var a, b;
    ...
    //---------------------------------------------------------------------------------------------------------
    R["(MapSet4) Support for Maps and Sets"] = function() {
      var a, b;

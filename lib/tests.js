...
(function() {
  ...
  module.exports = function(eq, ne) {
    ...
    R["emtpy array eqs empty array"] = function() {
      return eq([], []);
    };
    R["emtpy object eqs empty object"] = function() {
      return eq({}, {});
    };
    R["number object eqs primitive number of same value"] = function() {
      return eq(5, new Number(5));
    };
    R["string object eqs primitive string of same value"] = function() {
      return eq('helo', new String('helo'));
    };
    R["+0 should eq -0"] = function() {
      return eq(+0, -0);
    };
    ...
    /* 1.2. negative */
    R["object doesn't eq array"] = function() {
      return ne({}, []);
    };
    R["object in a list doesn't eq array in array"] = function() {
      return ne([{}], [[]]);
    };
    R["integer n doesn't eq rpr n"] = function() {
      return ne(1234, '1234');
    };
    R["empty array doesn't eq false"] = function() {
      return ne([], false);
    };
    R["array with an integer doesn't eq one with rpr n"] = function() {
      return ne([3], ['3']);
    };
    ...
    /* 2. complex tests */
    R["array with named member eqs other array with same member"] = function() {
      var d, e;
      d = ['foo', null, 3];
      d['extra'] = 42;
      e = ['foo', null, 3];
    ...
    R["array with named member doesn't eq array with same member, other value"] = function() {
      var d, e;
      d = ['foo', null, 3];
      d['extra'] = 42;
      e = ['foo', null, 3];
    ...
    R["circular arrays with same layout and same values are eq (1)"] = function() {
      var d, e;
      d = [1, 2, 3];
      d.push(d);
      e = [1, 2, 3];
    ...
    R["circular arrays with same layout and same values are eq (2)"] = function() {
      var d, e;
      d = [1, 2, 3];
      d.push(d);
      e = [1, 2, 3];

...
(function() {
  ...
  this.main = function() {
    var count_type, counter, counters, error, errors_type, fail_count, fails, fails_percentage, headers, idx, ignored, illegal, imp, imp_count, imp_key, imp_keys, imp_name, key, length, message, minus_points, name, options, pass_count, passes, passes_percentage, result, result_type, results_by_test_name, results_entry, row, sub_count, sub_error, sub_errors, success_by_imp_key, table_1, table_2, table_3, test, test_count, test_name, tests, title, width, _i, _j, _k, _l, _len, _len1, _len2, _len3, _ref, _ref1, _ref2, _ref3, _ref4;
    imp_count = 0;
    test_count = 0;
    fail_count = 0;
    counters = {};
    ...
    if (minus_points.length > 0) {
      ...
      for (_l = 0, _len3 = minus_points.length; _l < _len3; _l++) {
        _ref4 = minus_points[_l], imp_key = _ref4[0], test_name = _ref4[1], message = _ref4[2];

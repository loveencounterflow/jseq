(function() {
  //###########################################################################################################
  var ASSERT, BNP, LODASH, TRM, UNDERSCORE, alert, assert_paranoid_equal, badge, cjs_deep_eql, custom_jseq, custom_jseq_options, debug, deep_equal_ident, echo, fde_equal, fdq_equal, get_errorproof_comparator, help, info, is_equal, jdq_deepequal, jkroso_equals, jseq, jv_equals, log, othiym23_deepEqual, praise, rpr, should, should_equal, substack_deep_equal, urge, warn, whisper;
